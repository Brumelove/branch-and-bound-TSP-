...
public class Branch_Bounce_Node {
/**
 * A single node in the tree of paths
 */
    
    public Branch_Bounce_Node parent;
    ...
    /**
      * Constructs a new Branch_Bounce_Node
      *
      * 
      ...
      */
    public Branch_Bounce_Node(Branch_Bounce_Node parent, double parent_cost, double[][] distances, int[] active_set, int index) {
        this.parent = parent;
   ...
   /**
    ...
    /**
      ...
      *
      * @precondition Branch_Bounce_Node is not terminal
      * @return Array of children
      */
    public Branch_Bounce_Node[] generateChildren() {
        Branch_Bounce_Node[] children = new Branch_Bounce_Node[active_set.length - 1];
	...
	for(int j = 0; j < children.length; j++)
            children[j] = new Branch_Bounce_Node(this, distances[index][new_set[j]], distances, new_set, new_set[j]);
